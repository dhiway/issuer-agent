...
exports.retrieveExtrinsicFromBlock = exports.flattenCalls = exports.isBatch = void 0;
/**
 ...
 */
function isBatch(api, extrinsic) {
 ...
 */
function flattenCalls(api, call) {
    if (isBatch(api, call)) {
        // Inductive case
...
exports.flattenCalls = flattenCalls;
/**
 ...
 */
async function retrieveExtrinsicFromBlock(api, blockNumber, filter) {
...
exports.retrieveExtrinsicFromBlock = retrieveExtrinsicFromBlock;
