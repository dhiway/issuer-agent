 ...
 */
export async function connect(blockchainRpcWsUrl, { noInitWarn = ConfigService.get('logLevel') > 3, // by default warnings are disabled on log level error and higher
...apiOpts } = {}) {
