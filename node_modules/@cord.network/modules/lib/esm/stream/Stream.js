 ...
 *
 */
export function fromCredential(content) {
    const stream = {
 ...
 */
export function isIStream(input) {
    try {
 ...
 */
export function verifyAgainstCredential(stream, credential) {
    ...
    if (credentialMismatch || schemaMismatch) {
        throw new SDKErrors.CredentialUnverifiableError(`Some attributes of the stream diverge from the credential: ${[
            'schemaId',
            'streamHash',
        ]
