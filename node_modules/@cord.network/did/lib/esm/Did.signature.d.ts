import { DidResolveKey, DidResourceUri, DidSignature, DidUri, SignResponseData, VerificationKeyRelationship } from '@cord.network/types';
 ...
 */
export declare function verifyDidSignature({ message, signature, keyUri, expectedSigner, expectedVerificationMethod, didResolveKey, }: DidSignatureVerificationInput): Promise<void>;
/**
 ...
 */
export declare function isDidSignature(input: unknown): input is DidSignature;
/**
 ...
 */
export declare function signatureFromJson(input: DidSignature): Pick<SignResponseData, 'keyUri' | 'signature'>;
