...
export function validateUri(input, expectType) {
    ...
    if (fragment &&
        ...
        throw new SDKErrors.DidError('Expected a CORD DidUri but got a DidResourceUri (containing a #fragment)');
    }
    if (!fragment && expectType === 'ResourceUri') {
        throw new SDKErrors.DidError('Expected a CORD DidResourceUri (containing a #fragment) but got a DidUri');
    }
 ...
 */
export function getDidUri(didOrAddress) {
 ...
 * @returns The expected DID URI.
 */
export function getDidUriFromKey(key) {
