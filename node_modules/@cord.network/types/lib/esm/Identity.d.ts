...
export declare const ACCOUNT_IDENTIFIER_PREFIX: string;
export interface IIdentity {
    ...
    signSubmittableExtrinsic(submittableExtrinsic: SubmittableExtrinsic, nonce: AnyNumber | Index, tip?: AnyNumber): Promise<SubmittableExtrinsic>;
}
