 ...
 */
export type VerificationKeyRelationship = Extract<KeyRelationship, 'authentication' | 'capabilityDelegation' | 'assertionMethod'>;
/**
 ...
 */
export type DidVerificationKey = BaseDidKey & {
    type: VerificationKeyType;
};
/**
 * The SDK-specific details of a DID encryption key.
 */
export type DidEncryptionKey = BaseDidKey & {
    type: EncryptionKeyType;
};
/**
