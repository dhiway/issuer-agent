...
export type MessageBodyType = 'error' | 'reject' | 'request-stream' | 'submit-stream' | 'reject-stream' | 'request-payment' | 'confirm-payment' | 'request-credential' | 'submit-credential' | 'accept-credential' | 'reject-credential';
...
export type MessageBody = IError | IReject | IRequestStream | ISubmitStream | IRejectStream | IRequestCredential | ISubmitCredential | IAcceptCredential | IRejectCredential;
/**
