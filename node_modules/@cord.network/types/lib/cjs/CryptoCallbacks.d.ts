 ...
 */
export type SignCallback = (signData: SignRequestData) => Promise<SignResponseData>;
/**
 * A callback function to sign extrinsics.
 */
export type SignExtrinsicCallback = (signData: SignRequestData) => Promise<Omit<SignResponseData, 'keyUri'>>;
/**
