...
export type ResolvedDidKey = Pick<ConformingDidKey, 'id' | 'controller'> & Pick<DidKey, 'publicKey' | 'type' | 'includedAt'>;
 ...
 */
export type DidResolveKey = (didUri: DidResourceUri, expectedVerificationMethod?: KeyRelationship) => Promise<ResolvedDidKey>;
