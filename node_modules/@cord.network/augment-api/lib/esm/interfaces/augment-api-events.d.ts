...
declare module '@polkadot/api-base/types/events' {
    interface AugmentedEvents<ApiType extends ApiTypes> {
        ...
        did: {
             ...
             **/
            CallDispatched: AugmentedEvent<ApiType, [identifier: AccountId32, result: Result<Null, SpRuntimeDispatchError>], {
             ...
             **/
            Created: AugmentedEvent<ApiType, [author: AccountId32, identifier: AccountId32], {
                author: AccountId32;
                identifier: AccountId32;
            }>;
            /**
             ...
             * \[DID identifier\]
             **/
            Deleted: AugmentedEvent<ApiType, [identifier: AccountId32], {
                identifier: AccountId32;
            }>;
            /**
             ...
             * \[DID identifier\]
             **/
            Updated: AugmentedEvent<ApiType, [identifier: AccountId32], {
                identifier: AccountId32;
            }>;
        };
        didNames: {
             ...
             **/
            DidNameBanned: AugmentedEvent<ApiType, [name: Bytes], {
                name: Bytes;
            }>;
            /**
             * A new name has been claimed.
             **/
            DidNameClaimed: AugmentedEvent<ApiType, [owner: AccountId32, name: Bytes], {
                owner: AccountId32;
                name: Bytes;
            }>;
            /**
             ...
             **/
            DidNameReleased: AugmentedEvent<ApiType, [owner: AccountId32, name: Bytes], {
                owner: AccountId32;
                name: Bytes;
            }>;
            /**
             ...
             **/
            DidNameUnbanned: AugmentedEvent<ApiType, [name: Bytes], {
                name: Bytes;
            }>;
        };
        extrinsicAuthorship: {
            AuthorsAdded: AugmentedEvent<ApiType, [authorsAdded: Vec<AccountId32>], {
                authorsAdded: Vec<AccountId32>;
            }>;
            AuthorsRemoved: AugmentedEvent<ApiType, [authorsRemoved: Vec<AccountId32>], {
        ...
        registry: {
             ...
             **/
            AddAuthority: AugmentedEvent<ApiType, [registry_: Bytes, authority: AccountId32], {
                registry_: Bytes;
             ...
             * \[registry identifier,  authority\]
             **/
            AddAuthorization: AugmentedEvent<ApiType, [registry_: Bytes, delegate: AccountId32], {
                registry_: Bytes;
             ...
             * \[registry identifier,  authority\]
             **/
            Archive: AugmentedEvent<ApiType, [registry_: Bytes, authority: AccountId32], {
                registry_: Bytes;
                authority: AccountId32;
            }>;
            /**
             ...
             **/
            Create: AugmentedEvent<ApiType, [registry_: Bytes, creator: AccountId32], {
                registry_: Bytes;
                creator: AccountId32;
            }>;
            /**
             ...
             * \[registry identifier,  authority\]
             **/
            RemoveAuthority: AugmentedEvent<ApiType, [registry_: Bytes, delegate: AccountId32], {
                registry_: Bytes;
                delegate: AccountId32;
            }>;
            /**
             ...
             * \[registry identifier,  authority\]
             **/
            RemoveAuthorization: AugmentedEvent<ApiType, [registry_: Bytes, authorizationId: Bytes], {
                registry_: Bytes;
             ...
             * \[registry identifier,  authority\]
             **/
            Restore: AugmentedEvent<ApiType, [registry_: Bytes, authority: AccountId32], {
                registry_: Bytes;
                authority: AccountId32;
            }>;
        };
        ...
        schema: {
             ...
             **/
            Created: AugmentedEvent<ApiType, [identifier: Bytes, creator: AccountId32], {
                identifier: Bytes;
                creator: AccountId32;
            }>;
        };
        ...
        stream: {
             ...
             **/
            Create: AugmentedEvent<ApiType, [identifier: Bytes, digest: H256, author: AccountId32], {
                identifier: Bytes;
                digest: H256;
                author: AccountId32;
            }>;
             ...
             **/
            Digest: AugmentedEvent<ApiType, [identifier: Bytes, digest: H256, author: AccountId32], {
                identifier: Bytes;
                digest: H256;
                author: AccountId32;
            }>;
             ...
             **/
            Remove: AugmentedEvent<ApiType, [identifier: Bytes, author: AccountId32], {
                identifier: Bytes;
                author: AccountId32;
            }>;
            /**
             ...
             * \[stream identifier, controller\]
             **/
            Restore: AugmentedEvent<ApiType, [identifier: Bytes, author: AccountId32], {
                identifier: Bytes;
                author: AccountId32;
            }>;
            /**
             ...
             * \[stream identifier, controller\]
             **/
            Revoke: AugmentedEvent<ApiType, [identifier: Bytes, author: AccountId32], {
                identifier: Bytes;
                author: AccountId32;
            }>;
            /**
             ...
             * \[stream identifier, digest, controller\]
             **/
            Update: AugmentedEvent<ApiType, [identifier: Bytes, digest: H256, author: AccountId32], {
                identifier: Bytes;
                digest: H256;
                author: AccountId32;
            }>;
