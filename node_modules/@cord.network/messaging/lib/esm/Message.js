...
export function verifyMessageBody(body) {
    switch (body.type) {
        ...
        case 'request-credential': {
            body.content.schemas.forEach(({ schemaId, trustedAttesters, requiredProperties }) => {
        ...
        case 'accept-credential': {
            body.content.forEach((schemaId) => DataUtils.validateId(schemaId, 'Schema Identiifier'));
            break;
        }
 ...
 */
export function verifyRequiredSchemaProperties(requiredProperties, schema) {
        ...
        case 'request-stream':
            {
                ...
                if (!Did.isSameSubject(requestStream.content.credential.content.holder, sender)) {
